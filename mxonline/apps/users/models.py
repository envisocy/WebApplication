...
class EmailVerifyRecord(models.Model):
	...
	send_time = models.DateField(default=datetime.now, verbose_name=u"发送时间")     # 要把函数的括号去掉，才能正确拿到实例化的时间
...
class Banner(models.Model):
	...
	image = models.ImageField(upload_to="banner/%Y/%m", verbose_name=u"轮播图", max_length=255)
